...
/*
*
*   reference https://www.cnblogs.com/fanguangdexiaoyuer/p/6549306.html
*/
...
public class ConsistHash {
    ...
    public void test() throws InterruptedException {
        ...
        for (int i = 0; i < nodes.length; i++)
            System.out.println("[" + nodes[i] + "]的hash值为" + ConsistentHashingWithoutVirtualNode.getHash(nodes[i]) + ", 被路由到结点[" + ConsistentHashingWithoutVirtualNode.getServer(nodes[i]) + "]");
    }
}
